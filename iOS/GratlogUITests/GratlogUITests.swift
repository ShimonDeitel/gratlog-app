...
final class GratlogUITests: XCTestCase {
    ...
    func testAddEntryFlow() throws {
        ...
        nameField.tap()
        nameField.typeText("UI Test Client")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["UI Test Client"].waitForExistence(timeout: 2))
    }
    ...
    func testFreeLimitTriggersPaywall() throws {
        ...
        XCTAssertTrue(app.buttons["paywallPurchaseButton"].waitForExistence(timeout: 3) || app.staticTexts["Gratitude Pro"].waitForExistence(timeout: 2))
    }
